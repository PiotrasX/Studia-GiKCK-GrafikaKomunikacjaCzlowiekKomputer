...
public class Vec3i
{
    ...
    public static Vec3i add(Vec3i v1, Vec3i v2) { return new Vec3i(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z); }
    ...
    public Vec3i subtract(Vec3i vec) { return new Vec3i(this.x - vec.x, this.y - vec.y, this.z - vec.z); }
